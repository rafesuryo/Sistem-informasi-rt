...
<?php } ?>
				<tr>
					...
					<td colspan="2">
						...
						<a href="?mnu=kproposal"><input class="btn btn-danger" name="Batal" type="button" id="Batal" value="Batal" /></a>
					</td>
				</tr>
			</table>
		</form>
...
<div align="right">
<a href='?mnu=kproposal&pro=tambah'>
		...
		<div>
			...
			<table class="table table-bordered">
				<tr bgcolor="#cccccc">
					...
					<th width="5%"><label title='Dokumen Pengajuan Proposal'>PropMsk</label></td>
					<th width="5%"><label title='Dokumen Jawaban Atas Proposal Yang Masuk'>PropKlr</label></td>
...
?>
		...
		if (isset($_POST["Simpan"])) {
			...
			if ($pro == "simpan") {
				...
				if ($simpan) {
					echo "<script>alert('Data $nama_proposal berhasil disimpan !');document.location.href='?mnu=kproposal';</script>";
				} else {
					echo "<script>alert('Data $nama_proposal gagal disimpan...');document.location.href='?mnu=kproposal';</script>";
				}
			} 
		}
		?>