...
<?php } ?>
				<tr>
					...
					<td colspan="2">
						...
						<a href="?mnu=bsurat"><input class="btn btn-primary" name="Batal" type="button" id="Batal" value="Batal" /></a>
					</td>
				</tr>
			</table>
		</form>
...
+ Tambah Data</button></a>
		...
		<h3>Data Surat:</h3>
		<div>
			Data Surat | <img src='ypathicon/print.png' title='PRINT' OnClick="PRINT()"> |
...
<?php //  simpan
		if (isset($_POST["Simpan"])) {
			...
			if ($pro == "simpan") {
				...
				if ($simpan) {
					echo "<script>alert('Data $nama_surat berhasil disimpan !');document.location.href='?mnu=bsurat';</script>";
				} else {
					echo "<script>alert('Data $nama_surat gagal disimpan...');document.location.href='?mnu=bsurat';</script>";
				}
			} else {
				//update
			$id_surat0 = strip_tags($_POST["id_surat0"]);
				...
				if ($ubah) {
					echo "<script>alert('Data $nama_surat berhasil diubah !');document.location.href='?mnu=bsurat';</script>";
				} else {
					echo "<script>alert('Data $nama_surat gagal diubah...');document.location.href='?mnu=bsurat';</script>";
				}
			} //else simpan
		}
		?>