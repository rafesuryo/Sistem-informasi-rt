...
<script type="text/javascript">
	function PRINT() {
		win = window.open('surat/surat_print.php', 'win', 'width=1000, height=400, menubar=0, scrollbars=1, resizable=0, location=0, toolbar=0, status=0');
	}
</script>
...
$sql="select * from `$tbwarga`";
	...
	echo "<option value='$nik0'"; if($nik0==$nik){echo"selected";} echo">$nama_warga ($nik0)</option>";
				...
				<tr>
					...
					<td>:
					<td>
					<select class="form-control" name="id_pengguna" style="width: 250px;">
					<option selected disabled>-- Pilih --</option>
						<?php  
				...
				<tr>
					<td height="24"><label for="file_surat">File Surat</label>
					<td>:
